...
const PageLoading = () => {
    ...
    useEffect(() => {
        setTimeout(() => {
            const right = ref.current.querySelector(".right-section");
            const left = ref.current.querySelector(".left-section");
            const icon = ref.current.querySelector(".load-icon");
    ...
    return (
        <div ref={ref} className="page-loader">
            ...
            <div className="load-icon">
                <svg className="load-svg" xmlns="http://www.w3.org/2000/svg" width="201px" height="201px" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <defs>
                        <filter id="ldio-rje9hwily9l-filter" x="-100%" y="-100%" width="300%" height="300%" colorInterpolationFilters="sRGB">
                    ...
                    <g filter="url(#ldio-rje9hwily9l-filter)">
